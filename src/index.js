...
//* Vamos a poner las vistas de las diferentes pantallas 
...
if(esValida){
   ...
   numero = document.formtarjeta.number.value;
   document.getElementById('vista3').innerHTML= inputNombre.value.toUpperCase() +' '+ 'Tu tarjeta de credito'+ ' '
    + numMasky +' '+ 'es invalida ,por favor verifica los datos e intenta nuevamente';
}
}
